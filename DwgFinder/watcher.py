...
from .common import db_table
from .common import acquire_file_list
from .common import acquire_logger
from .common import watched_path
from .common import execute_sql


class DwgFileEventHandler(PatternMatchingEventHandler):
    def __init__(self):
        super(DwgFileEventHandler, self).__init__(
...
def start_watcher() -> Observer:
    ...
    """
    event_handler = DwgFileEventHandler()
    observer = Observer()
